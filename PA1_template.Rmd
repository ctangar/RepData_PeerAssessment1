...
Comment: README file in the GitHub repository show an example of what this plot should look like using simulated data.
...
**Note:** the results use sqldf library as alternative to R functions.
